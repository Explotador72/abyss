...
layout(rgba32f, set = 0, binding = 0) restrict writeonly uniform image2DArray displacement_map;
layout(rgba32f, set = 0, binding = 1) restrict writeonly uniform image2DArray normal_map;
layout(rgba32f, set = 0, binding = 2) restrict readonly uniform image2DArray previous_normal_map;
