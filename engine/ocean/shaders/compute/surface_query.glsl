...
layout(rgba32f, set = 0, binding = 3) restrict readonly uniform image2DArray current_displacements;
layout(rgba32f, set = 0, binding = 4) restrict readonly uniform image2DArray previous_displacements;
